...
const AdminDashboard = () => {
  ...
  const QUICK_CARDS = [
    { label: 'Total Bookings',  value: total,    icon: <FiCalendar />,    color: 'blue',   path: '/admin/bookings' },
    { label: 'Pending',         value: pending,  icon: <FiBarChart2 />,   color: 'accent', path: '/admin/bookings' },
    { label: 'Approved',        value: approved, icon: <FiCheckCircle />, color: 'green',  path: '/admin/bookings' },
    { label: 'Rejected',        value: rejected, icon: <FiXCircle />,     color: 'red',    path: '/admin/bookings' },
    { label: 'Facilities',      value: facilitiesCount.sport, icon: <FiUsers />, color: 'purple', path: '/admin/slots' },
    { label: 'Services',        value: facilitiesCount.service,   icon: <FiTrendingUp />, color: 'teal', path: '/admin/slots' },
  ];
        ...
        <div className="dash-section">
          ...
          <div className="dash-admin-nav">
            {[
              ...
              { label: '⚙️ Limits & Rules',  path: '/admin/limits' },
