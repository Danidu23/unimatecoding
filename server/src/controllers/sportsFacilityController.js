...
const getFacilities = async (req, res) => {
    try {
        const facilities = await SportsFacilityService.find({ active: true });
...
const getFacilityById = async (req, res) => {
    try {
        const facility = await SportsFacilityService.findById(req.params.id);
        if (facility) {
            res.json(facility);
        } else {
...
const createFacility = async (req, res) => {
    try {
        const facility = new SportsFacilityService(req.body);
