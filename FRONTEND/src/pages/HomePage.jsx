      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <div className="hero-cta">
            <button
              ...
              onClick={() => navigate('/book/facilities')}
            >
        ...
        <div className="hero-visual">
          ...
          <div className="hero-image-composition">
            <img src="https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=800&auto=format&fit=crop" alt="Gym" className="hero-img img-main" />
            <img src="https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=500&auto=format&fit=crop" alt="Sports" className="hero-img img-accent-1" />
            <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=500&auto=format&fit=crop" alt="Medical" className="hero-img img-accent-2" />
          </div>
        </div>
      </section>
