...
export default function ClaimLostFoundItemPage() {
  const { id } = useParams();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        navigate('/lost-found/submission-success', { state: { message: 'Your claim has been submitted and is awaiting admin approval.', itemType: 'Claim' } });
      } else {
